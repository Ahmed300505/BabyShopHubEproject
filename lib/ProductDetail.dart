import 'package:babyhubproject/SuggestedProductWork.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance.collection('Sujjestion-Product').limit(4).snapshots(),
                      ...
                      children: snapshot.data!.docs.map((doc) {
                        return GestureDetector(
                          ...
                          child: SujjestedProductCard(
                            ...
                            name: doc['title'],
                            price: doc['price'],
                            onAddToCart: () {}, // Add your function here if needed
                          ),
                        );
                      }).toList(),
                    ),
